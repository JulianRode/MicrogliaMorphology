...
// if batch mode = yes
	if(batchmodechoice){
		...
		ColorByCluster_originalimages = Array.sort(getFileList(ColorByCluster_originalimages_dir));
		...
		ColorByCluster_thresholdedimages = Array.sort(getFileList(ColorByCluster_thresholdedimages_dir));
		...
		ColorByCluster_clusters = Array.sort(getFileList(ColorByCluster_clusters_dir));
